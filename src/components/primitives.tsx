  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M22.27,12.46c-.29.5-.67.88-1.15,1.15s-.99.39-1.56.39-1.08-.13-1.56-.39c-.49-.26-.88-.64-1.17-1.15s-.44-1.11-.44-1.81.15-1.31.44-1.8c.29-.49.68-.88,1.17-1.15.49-.27,1.01-.4,1.56-.4s1.09.13,1.56.4c.47.27.85.65,1.15,1.15.29.5.44,1.1.44,1.8s-.15,1.31-.44,1.81Z" fill="none" stroke="currentColor" strokeWidth="1.6" />
        <path d="M48.88,7.89c-.24-.23-.53-.41-.87-.55-.34-.14-.72-.21-1.16-.21-.57,0-1.09.15-1.56.45-.47.3-.84.72-1.11,1.25-.09.18-.15.39-.21.6h5.7c-.02-.25-.09-.52-.23-.79-.13-.27-.32-.52-.56-.74Z" fill="none" stroke="currentColor" strokeWidth="1.6" />
        <path d="M43.97,9.42c.06-.21.12-.42.21-.6.27-.53.64-.95,1.11-1.25.47-.3.99-.45,1.56-.45.44,0,.82.07,1.16.21.34.14.63.33.87.55.24.22.43.47.56.74.14.27.21.53.23.79h-5.7Z" fill="none" stroke="currentColor" strokeWidth="1.6" />
        <rect x="87.51" y="5.06" width="2.95" height="11.48" fill="currentColor" />
        <path d="M89,3.8c.52,0,.97-.19,1.34-.56.37-.37.55-.82.55-1.35s-.18-.97-.55-1.34c-.37-.37-.81-.55-1.34-.55s-.98.18-1.35.55-.56.81-.56,1.34.19.98.56,1.35c.38.38.82.56,1.35.56Z" fill="currentColor" />
        ...
        <path d="M99.7,12.61c-.29.5-.67.88-1.15,1.15s-.99.39-1.56.39-1.08-.13-1.56-.39c-.49-.26-.88-.64-1.17-1.15s-.44-1.11-.44-1.81.15-1.31.44-1.8c.29-.49.68-.88,1.17-1.15.49-.27,1.01-.4,1.56-.4s1.09.13,1.56.4c.47.27.85.65,1.15,1.15.29.5.44,1.1.44,1.8s-.15,1.31-.44,1.81Z" fill="none" stroke="currentColor" strokeWidth="1.6" />
